        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="/lavajatocarioca/novo-servico">Serviço</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="/lavajatocarioca/lista-servicos">Serviços</a></li>
              <li class="divider"></li>
              <li><a href="/lavajatocarioca/lista-clientes">Clientes</a></li>
              <li><a href="/lavajatocarioca/lista-veiculos">Veículos</a></li>
            </ul>
          </li>
